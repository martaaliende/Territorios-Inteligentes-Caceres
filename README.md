...
Si la carpeta esta guardada en otra ubicación, cambia esta línea para que apunte a donde está.
...
- El script `descarga_datos.py` requiere conexión a internet para geocodificación inversa (Nominatim/OpenStreetMap) y opcionalmente para Google Places API.
